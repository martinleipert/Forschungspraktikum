...
def main():
	...
	argparser.add_argument("--trainFresh", type=bool, default=True, nargs='?',
	...
	argparser.add_argument("--swapSign", type=bool, nargs='?', default=False, help="Augment by swapping notary sign")
